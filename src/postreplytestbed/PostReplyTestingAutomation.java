 ...
 *
 * <p> NOTE: Error message strings must match your implementation exactly. </p>
 *
 * @author (your name)
 *
 */
public class PostReplyTestingAutomation {
	...
	/*****
	 * Creates a small, consistent dataset used by many tests.
	 * Posts:
	 *  - Post 1: contains "midterm" in body
	 *  - Post 2: does not contain "midterm"
	 */
	...
	/*****
	 * Seeds replies for postId=1 and postId=2.
	 */
